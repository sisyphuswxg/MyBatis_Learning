...
public class UserTest {
    ...
    public void TestInsert() throws Exception {
        ...
        user.setGender("男");
        user.setPassword("wangyiyi");
        user.setEmail("yiyi@gmail.com");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public void testFindUserList() throws Exception {
        ...
        for (UserInstance instance : userList) {
            UserInstance user = (UserInstance) instance;
...
//      	List<BatchItem.java> batchItemList=sqlSession.selectList("findBatchUserLazyLoading");
//      	BatchItem.java batchItem = null;
//      	Customer customer = null;
